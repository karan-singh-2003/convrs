        ...
        <TimeSeriesChart
          ...
          tooltipContent={(d) => {
            ...
            if (resource === "clicks") {
              ...
              return (
                <div className="w-[260px] font-alexandria py-3 px-1 space-y-2">
                  ...
                  <div className="flex justify-between text-sm">
                    <span className="font-medium text-content-subtle">Conversion rate</span>
                    <span className="font-medium text-content-subtle">{nFormatter(d.values.conversion_rate ?? 0)}%</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="font-medium text-content-subtle">Revenue/visitor</span>
                    <span className="font-medium text-content-subtle">{formatCurrency(d.values.revenue_per_visitor ?? 0, currency)}</span>
                  </div>
                </div>
              );
            }
            ...
            if (resource === "revenue") {
              ...
              return (
                <div className="w-[220px] font-alexandria py-3 px-1 space-y-2">
                  <p className="pb-1 border-b font-alexandria border-neutral-200 text-[12px] text-content-default font-medium">
                    {dateLabel}
                  </p>
                  <div className="space-y-1 pb-2 border-b border-neutral-200">
                    <div className="flex justify-between text-sm">
            ...
            return (
              <div className="w-[190px] py-3 space-y-2">
                <p className="md:text-[13px] pb-1 border-b border-border-subtle text-[12px] font-alexandria font-normal text-neutral-500">
                  {dateLabel}
                </p>
