...
// GET /api/v1/analytics/revenue — revenue-focused shortcut over the same
// composite call as /api/v1/analytics, with an explicit `currency` field.
// For revenue over time, use /api/v1/analytics/timeseries?metrics=revenue.
