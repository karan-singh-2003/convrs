    ...
    <Combobox
      ...
      trigger={
        <button
          type="button"
          disabled={disabled}
          className="flex w-full items-center justify-between rounded-lg border border-border-subtle bg-bg-emphasis/65 px-4 py-2 font-display text-[14.5px] text-content-default transition hover:bg-bg-emphasis/65 disabled:opacity-60 disabled:cursor-not-allowed"
        >
