  ...
  return (
    <Drawer.Root open={openPopover} onOpenChange={setOpenPopover}>
      ...
      <Drawer.Portal>
        ...
        <Drawer.Content
          className="fixed bottom-0 left-0 right-0 z-50 mt-2 rounded-none border-t border-border-subtle bg-bg-card"
  ...
  <PopoverPrimitive.Root open={openPopover} onOpenChange={setOpenPopover}>
    ...
    <PopoverPrimitive.Portal>
      <PopoverPrimitive.Content
        ...
        side={side}
        className={cn(
          "animate-slide-up-fade z-50 items-center rounded-none border border-border-subtle bg-bg-card shadow-lg sm:block",
          popoverContentClassName
        )}
        sticky={sticky}
