...
const triggerStyles = cva(
  [
    "group peer flex appearance-none items-center gap-x-2 truncate rounded-lg border px-3 h-9 outline-none transition-all text-sm",
      ...
      >
        ...
        <span className="flex-1 overflow-hidden text-ellipsis whitespace-nowrap text-left">
          {children ? (
            ...
            <span className="text-neutral-400 font-light font-alexandria">{placeholder}</span>
          ) : null}
        </span>
        <ChevronDown
