      ...
      <div className={cn("flex flex-col gap-y-1.5 w-full", className)}>
        <div className="relative w-full">
          <input
            ...
            className={cn(
              "h-10 w-full rounded-lg font-display border border-border-subtle bg-transparent px-3 text-sm md:text-[15px] text-content-default placeholder-neutral-400 transition-colors",
